...
[XSI1, XSI2] = meshgrid(-(exp_sim_param.number_of_pixels + 2 * exp_sim_param.number_of_pad_pixels)/2:(exp_sim_param.number_of_pixels + 2 * exp_sim_param.number_of_pad_pixels)/2-1, ...
