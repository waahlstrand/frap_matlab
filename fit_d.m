function [sys_param_hat, ss] = fit_d(C_prebleach, C_postbleach, exp_sim_param, fit_param)
...
%     options.StepTolerance = 1e-6;
    ...
    fun = @(param)negloglik_d(C_prebleach, C_postbleach, param, exp_sim_param, fit_param);
