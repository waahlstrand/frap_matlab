function nll = negloglik_db(C_prebleach, C_postbleach, sys_param, exp_sim_param, fit_param)

[C_prebleach_model, C_postbleach_model] = signal_db(sys_param, exp_sim_param);
