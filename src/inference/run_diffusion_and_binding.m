...
% lb_SI = [1e-10, 0, 0, 0.8, 0.25*number_of_pixels, 0.25*number_of_pixels, 5, 0, 0]; % (D, kon, koff, mf, x_bleach, y_bleach, r_bleach_region, intensity_inside_bleach_region, intensity_outside_bleach_region)
% ub_SI = [1e-9, 10, 10, 1, 0.75*number_of_pixels, 0.75*number_of_pixels, 0.5*number_of_pixels, 1, 1]; % (D, kon, koff, mf, x_bleach, y_bleach, r_bleach_region, intensity_inside_bleach_region, intensity_outside_bleach_region)
...
% param_guess_SI = [2.5e-10, 1.0, 1.0, 0.9, 0.5*number_of_pixels, 0.5*number_of_pixels, 30, 0.6, 0.9]; % (D, kon, koff, mf, x_bleach, y_bleach, r_bleach_region, intensity_inside_bleach_region, intensity_outside_bleach_region)
...
% Function handle.
% fun = @(param)residual(param(1), param(2), param(3), param(4), x_bleach, y_bleach, r_bleach_region, intensity_inside_bleach_region, intensity_outside_bleach_region, delta_t, image_data_post_bleach);
...
fun = @(param)residual(param(1), param(2), param(3), param(4), x_bleach, y_bleach, param(5), param(6), param(7), delta_t, image_data_post_bleach);
...
fun = @(param)sum( residual(param(1), param(2), param(3), param(4), x_bleach, y_bleach, param(5), param(6), param(7), delta_t, image_data_post_bleach).^2 );
