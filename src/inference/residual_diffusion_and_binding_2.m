function [F, J] = residual_diffusion_and_binding_2(  mobile_fraction, ...
...
if nargout > 1
    ...
    J = zeros(numel(image_data_post_bleach_model_unscaled), 3);
    ...
    J(:, 2) = 2 * ( mobile_fraction * image_data_post_bleach_model_unscaled + (1 - mobile_fraction) * initial_condition_model_unscaled ) - 1;
end