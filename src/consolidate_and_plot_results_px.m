...
for current_experiment = 1:number_of_experiments
    ...
    % D estimates.
    is_d_estimate = false;
    files_estimates = dir([file_paths{current_experiment}(1:end-4) '_est_d_px*']);
    ...
    files_estimates = dir([file_paths{current_experiment}(1:end-4) '_est_db_px*']);
    number_of_estimates = numel(files_estimates);
    if number_of_estimates >= 1
        is_db_estimate = true;
    ...
    box on
    print(gcf, [folder '/' 'recovery_curve_px.png'], '-dpng');
%     close
    ...
    if is_d_estimate && is_db_estimate
        save([folder '/' 'estimates_px.mat'], 'data', 'model_d', 'model_db', 'D_d', 'mf_d', 'Ib_d', 'Iu_d', 'D_db', 'k_on_db', 'k_off_db', 'mf_db', 'Ib_db', 'Iu_db', 'sum_of_squares_d', 'sum_of_squares_db');
    elseif is_d_estimate && ~is_db_estimate
        save([folder '/' 'estimates_px.mat'], 'data', 'model_d', 'D_d', 'mf_d', 'Ib_d', 'Iu_d', 'sum_of_squares_d');
    elseif ~is_d_estimate && is_db_estimate
        save([folder '/' 'estimates_px.mat'], 'data', 'model_db', 'D_db', 'k_on_db', 'k_off_db', 'mf_db', 'Ib_db', 'Iu_db', 'sum_of_squares_db');
    end
