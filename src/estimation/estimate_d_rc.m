function [param_hat, ss] = estimate_d_rc( ...
    data, ...
    param_bleach, ...
    delta_t, ...
    number_of_pixels, ...
...
% One fit with provided parameter guess or arbitrary many fits using
% random parameter guesses.
if ~isempty(param_guess)
    [param_hat, ss] = lsqnonlin( ...
        fun, ...
        param_guess, ...
        lb, ...
        ub, ...
